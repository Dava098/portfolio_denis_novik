  ...
  return (
    <section className={s.hero}>
      <div className={s.container}>
        <h2 className={s.subtitle}>Welcome to my Portfolio</h2>
        <h1 className={s.title}>
          Hi I’m <div className={s.extra}>Robert Junior</div> Product Designer
        </h1>
        <p className={s.text}>
        ...
        <div className={s.block}>
          ...
          <a className={s.download} href="/hero.jpg" download>
            Download CV
            <svg
              className={s.icon}
              width="21"
      ...
      <img className={s.logo} src="/hero.jpg" alt="hero" />
    </section>
  );
};
